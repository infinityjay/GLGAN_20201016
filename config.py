...
parser.add_argument('--local_input_height', dest='local_input_height', default=32, help='local input image height')
...
parser.add_argument('--train_step', dest='train_step', default=4000, help='total number of train_step')
parser.add_argument('--Tc', dest='Tc', default=300, help='Tc to train Completion Network')
...
parser.add_argument('--alpha', dest='alpha', default=1, help='alpha')
