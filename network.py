...
class network():
    def __init__(self, args: object) -> object:
        ...
        # self.orig_img, self.test_img, self.test_mask, self.test_data_count = load_result_data(args)#train的时候用，避免placeholder传参

        self.single_orig = tf.placeholder(tf.float32, (args.batch_size, args.input_height, args.input_width, 3))#test的时候用
